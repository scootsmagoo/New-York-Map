...
export const SETTLEMENTS: Settlement[] = [
  ...
  },
  {
    id: "el-barrio",
    name: "El Barrio",
    primaryGroup: "puerto_rican",
    groups: ["puerto_rican"],
    coords: [-73.9475, 40.7955],
    radiusDeg: 0.0045,
    from: 1920,
    note: "Puerto Ricans, U.S. citizens since 1917, settle in East Harlem below 116th Street as the Italians move on.",
  },
  {
    id: "bed-stuy",
    ...
    primaryGroup: "free_black",
    groups: ["free_black"],
    coords: [-73.9415, 40.6835],
    radiusDeg: 0.007,
    from: 1930,
    greaterNYOnly: true,
    note: "The A train (1936) links Harlem to central Brooklyn, which becomes the city's second great Black neighborhood.",
  },
  {
    id: "vinegar-hill",
