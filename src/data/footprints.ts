...
const snapshots: FootprintSnapshot[] = [
...

  {
    ...
    other: [
      [
        // Brooklyn built out to Coney Island, Sheepshead Bay, and Canarsie
        [-74.045, 40.63],
        [-74.03, 40.6],
        [-74.01, 40.585],
        [-73.99, 40.57],
      ...
      [
        // Queens: subway suburbs from Astoria and Jackson Heights to Jamaica and Bayside
        [-73.962, 40.74],
        [-73.94, 40.72],
        [-73.905, 40.705],
        [-73.87, 40.69],
      ...
      [
        // The Bronx to the city line, Riverdale to Throgs Neck
        [-73.9355, 40.7905],
        [-73.9035, 40.785],
        [-73.8705, 40.7895],
        [-73.845, 40.8],
      ...
      blob(-73.842, 40.66, 0.008), // Howard Beach
      [
        // Rockaway peninsula strip
        [-73.9395, 40.5505],
        [-73.8625, 40.5705],
      ...
      [
        // Staten Island: the North Shore and the East Shore to Midland Beach
        [-74.206, 40.635],
        [-74.16, 40.62],
        [-74.12, 40.605],
        [-74.09, 40.575],
      ...
      blob(-74.15, 40.552, 0.008), // Great Kills
